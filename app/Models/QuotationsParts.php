...
class QuotationsParts extends Model
{
    ...
    public function distributeIns(){
			...
			try {
				...
				$sqlString .= "    , t1.m_code ";
				$sqlString .= "    , t1.seq ";
				$sqlString .= "    , t1.parts_code ";
				$sqlString .= "    , t1.paper_code ";
				$sqlString .= "    , t1.paper_name ";
				$sqlString .= "    , t1.p_supply ";
				$sqlString .= "    , t1.size_w ";
				$sqlString .= "    , t1.size_h ";
				...
				$sqlString .= "    , t1.p_color_front ";
				$sqlString .= "    , t1.p_color_back ";
				$sqlString .= "    , t1.p_desensitization ";
				$sqlString .= "    , t1.p_carbon ";
				$sqlString .= "    , t1.p_white ";
				$sqlString .= "    , t1.p_separate ";
				$sqlString .= "    , t1.p_through ";
				$sqlString .= "    , t1.p_sheet ";
				$sqlString .= "    , t1.p_mm_apply ";
				$sqlString .= "    , t1.p_mm_dispose ";
				$sqlString .= "    , t1.p_mm_unit ";
				$sqlString .= "    , t1.p_printing_cost ";
				$sqlString .= "    , t1.p_necessary_sheet ";
				$sqlString .= "    , t1.p_paper_price ";
				$sqlString .= "    , t1.p_form_sewingmachine_w ";
				$sqlString .= "    , t1.p_form_sewingmachine_h ";
				$sqlString .= "    , t1.p_form_jump_sewingmachine_w ";
				$sqlString .= "    , t1.p_form_jump_sewingmachine_h ";
				$sqlString .= "    , t1.p_form_micro_sewingmachine_w ";
				$sqlString .= "    , t1.p_form_micro_sewingmachine_h ";
				$sqlString .= "    , t1.p_form_jump_micro_sewingmachine_w ";
				$sqlString .= "    , t1.p_form_jump_micro_sewingmachine_h ";
				$sqlString .= "    , t1.p_form_linein_w ";
				$sqlString .= "    , t1.p_form_linein_h ";
				$sqlString .= "    , t1.p_form_slitter_w ";
				$sqlString .= "    , t1.p_form_slitter_h ";
				$sqlString .= "    , t1.p_form_no ";
				$sqlString .= "    , t1.p_form_sewingmachine_ks ";
				$sqlString .= "    , t1.p_form_jump_sewingmachine_ks ";
				$sqlString .= "    , t1.p_form_micro_sewingmachine_ks ";
				$sqlString .= "    , t1.p_form_jump_micro_sewingmachine_ks ";
				$sqlString .= "    , t1.p_form_linein_ks ";
				$sqlString .= "    , t1.p_form_slitter_ks ";
				$sqlString .= "    , t1.p_form_no_ks ";
				$sqlString .= "    , t1.p_form_subtotal ";
				$sqlString .= "    , t1.p_offset_sewingmachine_w ";
				$sqlString .= "    , t1.p_offset_no ";
				$sqlString .= "    , t1.p_offset_sewingmachine_ks ";
				$sqlString .= "    , t1.p_offset_no_ks ";
				$sqlString .= "    , t1.p_offset_subtotal ";
				$sqlString .= "    , t1.p_letterpress_sewingmachine_hon ";
				$sqlString .= "    , t1.p_letterpress_sewingmachine_dai ";
				$sqlString .= "    , t1.p_letterpress_jump_sewingmachine_hon ";
				$sqlString .= "    , t1.p_letterpress_jump_sewingmachine_dai ";
				$sqlString .= "    , t1.p_letterpress_micro_sewingmachine_hon ";
				$sqlString .= "    , t1.p_letterpress_micro_sewingmachine_dai ";
				$sqlString .= "    , t1.p_letterpress_jump_micro_sewingmachine_hon ";
				$sqlString .= "    , t1.p_letterpress_jump_micro_sewingmachine_dai ";
				$sqlString .= "    , t1.p_letterpress_linein_hon ";
				$sqlString .= "    , t1.p_letterpress_linein_dai ";
				$sqlString .= "    , t1.p_letterpress_slitter_hon ";
				$sqlString .= "    , t1.p_letterpress_slitter_dai ";
				$sqlString .= "    , t1.p_letterpress_diecut ";
				$sqlString .= "    , t1.p_letterpress_pcno ";
				$sqlString .= "    , t1.p_letterpress_no ";
				$sqlString .= "    , t1.p_letterpress_sewingmachine_ks ";
				$sqlString .= "    , t1.p_letterpress_jump_sewingmachine_ks ";
				$sqlString .= "    , t1.p_letterpress_micro_sewingmachine_ks ";
				$sqlString .= "    , t1.p_letterpress_jump_micro_sewingmachine_ks ";
				$sqlString .= "    , t1.p_letterpress_linein_ks ";
				$sqlString .= "    , t1.p_letterpress_slitter_ks ";
				$sqlString .= "    , t1.p_letterpress_diecut_ks ";
				$sqlString .= "    , t1.p_letterpress_pcno_ks ";
				$sqlString .= "    , t1.p_letterpress_no_ks ";
				$sqlString .= "    , t1.p_letterpress_subtotal ";
				$sqlString .= "    , t1.p_info_toray ";
				$sqlString .= "    , t1.p_info_ijp ";
				$sqlString .= "    , t1.p_info_dot_line ";
				$sqlString .= "    , t1.p_info_dot_dai ";
				$sqlString .= "    , t1.p_info_basic_fee ";
				$sqlString .= "    , t1.p_info_output ";
				$sqlString .= "    , t1.p_info_punching ";
				$sqlString .= "    , t1.p_info_subtotal ";
				$sqlString .= "    , t1.p_diecutter_sewingmachine_hon ";
				$sqlString .= "    , t1.p_diecutter_sewingmachine_dai ";
				$sqlString .= "    , t1.p_diecutter_jump_sewingmachine_hon ";
				$sqlString .= "    , t1.p_diecutter_jump_sewingmachine_dai ";
				$sqlString .= "    , t1.p_diecutter_micro_sewingmachine_hon ";
				$sqlString .= "    , t1.p_diecutter_micro_sewingmachine_dai ";
				$sqlString .= "    , t1.p_diecutter_jump_micro_sewingmachine_hon ";
				$sqlString .= "    , t1.p_diecutter_jump_micro_sewingmachine_dai ";
				$sqlString .= "    , t1.p_diecutter_ana_hon ";
				$sqlString .= "    , t1.p_diecutter_ana_dai ";
				$sqlString .= "    , t1.p_diecutter_cornercut ";
				$sqlString .= "    , t1.p_diecutter_cornercut_dai ";
				$sqlString .= "    , t1.p_diecutter_sewingmachine_ks ";
				$sqlString .= "    , t1.p_diecutter_jump_sewingmachine_ks ";
				$sqlString .= "    , t1.p_diecutter_micro_sewingmachine_ks ";
				$sqlString .= "    , t1.p_diecutter_jump_micro_sewingmachine_ks ";
				$sqlString .= "    , t1.p_diecutter_ana_ks ";
				$sqlString .= "    , t1.p_diecutter_cornercut_ks ";
				$sqlString .= "    , t1.p_diecutter_subtotal ";
				$sqlString .= "    , t1.outsource_paper ";
				$sqlString .= "    , t1.outsource_paper_cost ";
				$sqlString .= "    , t1.outsource_paper_all ";
				$sqlString .= "    , t1.outsource_paper_all_cost ";
				$sqlString .= "    , t1.p_form_cornercut ";
				$sqlString .= "    , t1.p_form_replace ";
				$sqlString .= "    , t1.p_form_replace_color ";
				$sqlString .= "    , t1.p_envelope ";
