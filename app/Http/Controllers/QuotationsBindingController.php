...
class QuotationsBindingController extends Controller
{
    public function index()
    {
        $authusers = Auth::user();
        return view('quotationsbinding', compact('authusers'));
    }
    ...
    public function getData(Request $request){
        ...
        try {
            ...
            $q_binding = new QuotationsBinding();
            if(isset($s_m_code))      $q_binding->setParamM_codeAttribute($s_m_code);
            $details =  $q_binding->getSearch();
