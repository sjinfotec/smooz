...
#sudo -S scp -i /root/.ssh/id_rsa $ORIGINAL_FILE_PATH $DESTINATION_FILE_PATH
...
#sudo -S scp -i /root/.ssh/id_rsa $1":"$3$2 $4 >>$5$2"_"$6"_$(date +'%Y%m%d').log" 2>>$5$2"_"$6"_$(date +'%Y%m%d').log"
