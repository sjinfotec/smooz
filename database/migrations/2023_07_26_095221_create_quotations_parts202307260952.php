...
class CreateQuotationsParts202307260952 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('quotations_parts', function (Blueprint $table) {
            ...
            $table->char('p_color_front',2)->nullable()->comment('色数表');
            $table->char('p_color_back',2)->nullable()->comment('フォーム 色数裏');
            ...
            $table->char('p_offset_sewingmachine_ks', 1)->nullable()->comment('ミシン基・セ');
            ...
            $table->char('p_info_toray',2)->nullable()->comment('東レ台数');
            $table->char('p_info_ijp',2)->nullable()->comment('フォーム ＩＪＰ台数');
            ...
            $table->char('p_envelope',1)->nullable()->comment(' 封筒加工加算マーク');
