...
class CreateWrkQuotationsDepartmentTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('wrk_quotations_department', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('wrk_quotations_department');
    }
}
