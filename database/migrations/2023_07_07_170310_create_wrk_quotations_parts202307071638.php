...
class CreateWrkQuotationsParts202307071638 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('wrk_quotations_parts', function (Blueprint $table) {
            ...
            $table->tinyInteger('p_info_ijp')->nullable()->comment('フォーム ＩＪＰ');
    ...
    {
        Schema::dropIfExists('wrk_quotations_parts');
    }
}
